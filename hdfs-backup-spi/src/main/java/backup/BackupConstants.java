...
public class BackupConstants {
  ...
  public static final String DFS_BACKUP_DATANODE_BACKUP_VALIDATE_RETRY_COUNT_KEY = "DFS_BACKUP_DATANODE_BACKUP_VALIDATE_RETRY_COUNT";
  public static final int DFS_BACKUP_DATANODE_BACKUP_VALIDATE_RETRY_COUNT_DEFAULT = 3;

  public static final String DFS_BACKUP_DATANODE_BACKUP_VALIDATE_DELAY_KEY = "DFS_BACKUP_DATANODE_BACKUP_VALIDATE_DELAY";
  public static final int DFS_BACKUP_DATANODE_BACKUP_VALIDATE_DELAY_DEFAULT = 20;

  public static final String DFS_BACKUP_DATANODE_BACKUP_VALIDATE_PERIOD_KEY = "DFS_BACKUP_DATANODE_BACKUP_VALIDATE_PERIOD";
  public static final int DFS_BACKUP_DATANODE_BACKUP_VALIDATE_PERIOD_DEFAULT = 60;

  public static final String DFS_BACKUP_NAMENODE_BLOCK_CHECK_DELETE_BATCH_SIZE_KEY = "DFS_BACKUP_NAMENODE_BLOCK_CHECK_DELETE_BATCH_SIZE";
  public static final int DFS_BACKUP_NAMENODE_BLOCK_CHECK_DELETE_BATCH_SIZE_DEFAULT = 100;
}
